...
|---|---|---|---|---|---|
| 2026-09-20 | Linux (headless harness) | — | — | branch for #76 | `UiScaleDisableTest`: under simulated Synthetica-scaled fonts (Dialog 18 / 24 pt) dark mode keeps the size, FlatLaf system scaling stays on, user scale stays 1.0. Closes the investigation in [#76](https://github.com/Mustry-Solutions/ignition-designer-dark-mode-module/issues/76); a live Windows/Linux `env:` block remains welcome via [#96](https://github.com/Mustry-Solutions/ignition-designer-dark-mode-module/issues/96) |
