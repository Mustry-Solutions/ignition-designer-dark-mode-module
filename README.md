...
carried a FlatLaf border by name. Fixed since; a window saved that way is repaired by
any save from a Designer running the fix, or on 0.4.0 by a light save.
