...
carried a FlatLaf border by name. Fixed in 0.4.1; a window saved that way is repaired by
any save from a Designer running 0.4.1, or on 0.4.0 by a light save.
